...
*   **Smart Speech Bubble Clustering & Multi-pass OCR:** ผสานพลัง EasyOCR และ PP-OCR ร่วมกับอัลกอริทึมรวมกล่องคำพูดอัจฉริยะ ช่วยรวมประโยคในบอลลูนคำพูดเดียวกันให้อ่านเข้าใจง่ายและกำจัดอักขระขยะ (`$`, `~`) 100%
*   **Viterbi Word Segmenter & Offline Dictionary:** ระบบแยกคำติดกันและตรวจสะกดอัจฉริยะ แก้ปัญหากล่องข้อความคำปนกันทำให้อ่านไม่รู้เรื่อง
