...
(function() {
    ...
    function createToggleUI() {
        ...
        const models = [
            ...
            { value: 'llama3:8b', label: 'Local: Llama 3 8B' },
            { value: 'gemma2:9b', label: 'Local: Gemma 2 9B' },
            { value: 'qwen3:8b', label: 'Local: Qwen 3 8B' },
            { value: 'qwen2.5:3b', label: 'Local: Qwen 2.5 3B' }
        ];
